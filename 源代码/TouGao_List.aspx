<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TouGao_List.aspx.cs" Inherits="TouGao_List" %>
<head>
    <style type="text/css">
        .style1
        {
    ...
    <td align="left">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DanWei" HeaderText="工作单位">
                            <HeaderStyle HorizontalAlign="Left" />
                              <ItemStyle HorizontalAlign="Left" />
                           </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="编辑" ShowHeader="False">
                                <ItemTemplate>
                           <a href='TouGao.aspx?ID=<%#Eval("ID") %>'><img src="images/edt.gif"  height="15px" style="border:none;" /></a>
