<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BianJi_List.aspx.cs" Inherits="BianJi_List" %>
<head>
    <style type="text/css">
        .style1
        {
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="编辑" ShowHeader="False">
                                <ItemTemplate>
                           <a href='BianJi.aspx?ID=<%#Eval("ID") %>'><img src="images/edt.gif"  height="15px" style="border:none;" /></a>
